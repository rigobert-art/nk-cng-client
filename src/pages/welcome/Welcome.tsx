...
const Welcome = () => {
  return (
    <section className="w-full h-screen flex flex-col overflow-hidden items-center justify-center px-4 font-serif">
      ...
      <div className="absolute right-4 top-4 bg-green-900 rounded-xl flex justify-center items-center">
      ...
      <div className="lg:w-[600px] mx-auto justify-center items-center text-center">
        <div className="mb-8">
          <h1 className="text-2xl font-extrabold mb-4">NK CNG AUTOMOTIVE LOAN!</h1>
          <p className="text-sm font-bold text-gray-400 text-wrap">
            Loans provided by NK CNG Automotive Limited to help you to do conversion
            of you car from fuel to gas
          </p>
        </div>

        <Link to="/details" className="bg-green-800 text-white rounded-md shadow-lg px-4 py-2">
          Welcome
        </Link>
      </div>
    </section>
